...
export HIVE_HOME=/opt/zfs/sys/apache-hive-4.2.0-bin
export HIVE_CONF_DIR=/opt/zfs/sys/apache-hive-4.2.0-bin/conf

#export PIG_HOME=/opt/zfs/sys/pig-0.17.0

export SPARK_HOME=/opt/zfs/sys/spark-4.1.2-bin-hadoop3
export SPARK_CONF_DIR=/opt/zfs/sys/spark-4.1.2-bin-hadoop3/conf 
